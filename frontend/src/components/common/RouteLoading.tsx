  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="relative mb-6">
        <div className="h-14 w-14 animate-[spin_2.5s_linear_infinite] rounded-full border-[2px] border-neutral-200 dark:border-white/5 border-t-primary-500" />
      ...
      <motion.p
        className="text-sm text-neutral-500 dark:text-white/35"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
